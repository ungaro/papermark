...
export type StorageRegion = "eu-central-1" | "us-east-1";
 ...
 *
 * @param storageRegion - The storage region ('us-east-1' for US, defaults to 'eu-central-1' for EU)
...
export function getStorageConfig(storageRegion?: string): StorageConfig {
  const isUS = storageRegion === "us-east-1";
